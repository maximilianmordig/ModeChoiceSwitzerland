...
V1 = ASC_TRAIN * one + B_TRAIN_TIME * TRAIN_TIME + B_COST_TRAIN * TRAIN_COST + B_LANG_CODE * LANG_CODE
V2 = ASC_CAR * one + B_CAR_TIME * CAR_TIME + B_COST_CAR * CAR_COST + B_CAR_AVAIL1 * CAR_AVAIL1 + B_CAR_AVAIL2 * CAR_AVAIL2 + B_CAR_AVAIL3 * CAR_AVAIL3 + B_FreqCarPar1*FREQ_CAR_PAR1 + B_FreqCarPar2*FREQ_CAR_PAR2 + B_FreqCarPar34*FREQ_CAR_PAR34
V3 = ASC_WALK * one + B_WALK_DIST * DISTANCE + B_TRIP_PURPOSE * TRIP_PURPOSE+ B_LANG_CODE * LANG_CODE
